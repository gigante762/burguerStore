    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between flex-wrap border rounded-top pt-4 px-3">
            ...
            <div class="mb-4 mx-2 flex-even">
                ...
                <label class="btn btn-outline-dark p-4 h-100 w-100" for="pag1">
                    <h3>
            ...
            <div class="mb-4 mx-2 flex-even">
                ...
                <label class="btn btn-outline-dark p-4 h-100 w-100" for="pag2">
                    ...
                    @endif
                    @endforeach
                        <h4>Valor da Compra: <b>R$ {{ number_format($total,2,',','.') }}</b></h4>
                        <br>
                        <p>
        ...
        <div class="text-end border border-top-0 rounded-bottom p-4 pb-0">
            <a href="{{route('site.cart')}}" class="btn btn-outline-success btn-lg mb-4">
                Voltar ao carrinho
            </a>
            {{-- <a href="fechamento_endereco.html" class="btn btn-outline-success btn-lg mb-4">
                Voltar aos Endereços
            </a> --}}
            <a href="fechamento_pedido.html" class="btn text-white cor-principal btn-lg ms-2 mb-4">Finalizar</a>
        </div>
    </div>
</main>
@endsection
